    ...
    <div className={_style.wrapper}>
      ...
      <section className={_style.container}>
        <div className={_style.info}>
          <p>
            Greetings, I&apos;m João Pinheiro, a seasoned full stack developer
          ...
          <p>
            ...
            music educator, DJ, producer, and live performer. However, my
            inherent passion for arts, design, and technology led me to a
            pivotal decision in 2020 — to embark on a programming career.
          </p>
          <br />
          <p>
            What sets me apart is my analytical acumen and a strong aptitude for
            critical thinking. I excel in the dissection of intricate
            challenges, wielding a discerning eye to transform chaos into order.
          </p>
          <br />
          <p>
