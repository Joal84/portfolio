...
export default function Home() {
  ...
  useEffect(() => {
    inViewAbout && controlsAbout.start("visible");
    inViewProjects && controlsProjects.start("visible");
    inViewTech && controlsTech.start("visible");
  }, [
    controlsAbout,
    controlsProjects,
    controlsTech,
        ...
        >
          <div className={_style.outterWrapperLast}>
            ...
            <div className={_style.wrapper}>
              <p className={_style.subtext}>
                Includes programming languages, frameworks, libraries,
                databases, and tools I&apos;m skilled in.
              </p>
              <TechStack />
            </div>
            <Divider />
